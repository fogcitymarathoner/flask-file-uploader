...
s3 = boto.connect_s3(app.config['AWS_ACCESS_KEY_ID'], app.config['AWS_SECRET_ACCESS_KEY'], is_secure=False)
# test aws credentials
try:
    bucket = s3.get_bucket('akiajaxy4lmfnr2gtlea-test-bucket')
...
if __name__ == '__main__':
    app.run(debug = True, host='0.0.0.0', port=9193)
